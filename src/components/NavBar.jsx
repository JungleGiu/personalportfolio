...
const NavBar = () => {
  ...
  return (
    <nav className="flex justify-between items-stretch h-15 bg-white text-blue-950 border-2 ">
      <div className="text-lg font-bold h-full ">
        <h1 className="flex items-center h-full mr-10 pl-5">Giú Eminente </h1>
      </div>
      <div className="text-sm">
        <ul className="flex space-x-8 divide-x h-full">
